...
--
-- TOC entry 241 (class 1255 OID 159305)
...
--
-- TOC entry 242 (class 1255 OID 159306)
...
--
-- TOC entry 244 (class 1255 OID 159307)
...
BEGIN
	...
	INNER JOIN flightsprogram fp ON f.fcode=fp.flight_code
	WHERE program_id=prog_id INTO v_dr;
...
--
-- TOC entry 245 (class 1255 OID 159308)
...
--
-- TOC entry 246 (class 1255 OID 159309)
...
--
-- TOC entry 247 (class 1255 OID 159310)
...
--
-- TOC entry 248 (class 1255 OID 159311)
...
--
-- TOC entry 249 (class 1255 OID 159312)
...
--
-- TOC entry 250 (class 1255 OID 159313)
...
--
-- TOC entry 243 (class 1255 OID 159314)
...
--
-- TOC entry 251 (class 1255 OID 159315)
-- Name: tr_flightschedule(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION tr_flightschedule() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  dr numeric; -- diarkeia tis ptisis
  t_hr numeric; -- synolikes wres ptisis tou aeroskafous
  sc_hr numeric; -- wres ptisis pou prokeitai na ginoun (yparxoun mesa sto flight schedule)
  a_status smallint; -- ptitiki ikanotita aeroskafous
  dp_time time;
  air_exists integer;
  fl_count integer;
  start_dt date;
...
INNER JOIN flightsprogram fp ON f.fcode=fp.flight_code
WHERE program_id=NEW.fprogram_id INTO dr, dp_time;
-- Check if an aircraft is in another flight in same day and hour
SELECT count(*) FROM flight f 
INNER JOIN flightsprogram fp ON f.fcode=fp.flight_code
INNER JOIN flightschedule fs ON fp.program_id=fs.fprogram_id
WHERE aircraft_code=NEW.aircraft_code AND fdate=NEW.fdate AND NEW.fdate+f.dep_time BETWEEN (NEW.fdate+(dp_time-'00:30'::interval)) AND NEW.fdate+dp_time+((f.arr_time-f.dep_time)*2)+'01:00'::interval INTO fl_count;
-- Check if the flight date is the same with flight date from flightsprogram
SELECT start_date, end_date FROM flightsprogram WHERE program_id=NEW.fprogram_id INTO start_dt, end_dt;
SELECT array(SELECT days FROM flight_days fd WHERE fcode=(select flight_code from flightsprogram where program_id=NEW.fprogram_id)) INTO day_1;
SELECT to_char(NEW.fdate,'DY') INTO day_2;
-- Check if the aircraft you try to insert belongs to the right type	
   IF NEW.aircraft_code NOT IN (SELECT code FROM aircraft a INNER JOIN aircraft_type atp ON a.type_id=atp.id INNER JOIN flightsprogram fp ON atp.id=fp.aircraft_type WHERE program_id=NEW.fprogram_id) THEN
	RAISE EXCEPTION 'Aircraft % is different type.',NEW.aircraft_code;
   END IF;
-- Check if flight exists on schedule
SELECT 1 FROM flightschedule WHERE fprogram_id=NEW.fprogram_id AND fdate=NEW.fdate AND NOT EXISTS (SELECT * FROM flightschedule WHERE fschedule_id=NEW.fschedule_id) INTO air_exists;
   IF NEW.fdate NOT BETWEEN start_dt AND end_dt THEN
	RAISE EXCEPTION 'The flight % isnt available at date %.',NEW.fprogram_id,NEW.fdate;
   END IF;
   IF day_2 NOT IN (select(unnest(day_1))) THEN
	RAISE EXCEPTION 'This flight isnt available on % .',day_2;
   END IF;
   IF air_exists=1 THEN
	RAISE EXCEPTION 'Flight % is already scheduled at % date.',NEW.fprogram_id,NEW.fdate;
   END IF; 
    IF fl_count>1 THEN
	RAISE EXCEPTION 'Aircraft % is in another flight in the same hour and day', NEW.aircraft_code;
   END IF;
RETURN NEW;
END;
$$;
...
ALTER FUNCTION public.tr_flightschedule() OWNER TO postgres;

--
-- TOC entry 252 (class 1255 OID 159316)
-- Name: tr_staffschedule(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION tr_staffschedule() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  ispilot integer;
...
inner join flightsprogram fp on f.fcode=fp.flight_code
inner join flightschedule fs on fp.program_id=fs.fprogram_id
where fs.fschedule_id=NEW.fschedule_id INTO dr, dp_time; 
-- check if emp is pilot or attendant
select 1 from fspilots where emp_id=NEW.emp_id INTO ispilot;
select 1 from fsattendant where emp_id=NEW.emp_id INTO isattendant;
-- Check if the flight date is the same with flight date from flightschedule
SELECT fdate FROM flightschedule WHERE fschedule_id=NEW.fschedule_id INTO str_dt;
IF (NEW.fdate::date)<>str_dt THEN
RAISE EXCEPTION 'The flight % isnt available at date %.',NEW.fschedule_id,NEW.fdate;
END IF;
-- Check if a pilot is scheduled for this flight
IF (TG_OP = 'INSERT') THEN 
select count(*) from staffschedule ss inner join fspilots pil on ss.emp_id=pil.emp_id where fschedule_id=NEW.fschedule_id INTO c_pil;
select count(*) from staffschedule ss inner join fsattendant att on ss.emp_id=att.emp_id where fschedule_id=NEW.fschedule_id INTO c_att;
ELSIF (TG_OP = 'UPDATE') THEN
select count(*) from staffschedule ss inner join fspilots pil on ss.emp_id=pil.emp_id where fschedule_id=NEW.fschedule_id and not exists (select * from staffschedule where emp_id=OLD.emp_id and fschedule_id=NEW.fschedule_id)  INTO c_pil;
select count(*) from staffschedule ss inner join fsattendant att on ss.emp_id=att.emp_id where fschedule_id=NEW.fschedule_id and not exists (select * from staffschedule where emp_id=OLD.emp_id and fschedule_id=NEW.fschedule_id) INTO c_att;
END IF;
   IF (c_pil=1) AND (ispilot=1) THEN
   RAISE EXCEPTION 'A pilot is already scheduled for flight %', NEW.fschedule_id;
   END IF;
   IF (c_att=2) AND (isattendant=1) THEN
   RAISE EXCEPTION 'Attendants are already scheduled for flight %', NEW.fschedule_id;
   END IF;
...
ALTER FUNCTION public.tr_staffschedule() OWNER TO postgres;

--
-- TOC entry 253 (class 1255 OID 159317)
...
--
-- TOC entry 254 (class 1255 OID 159318)
...
--
-- TOC entry 255 (class 1255 OID 159319)
...
--
-- TOC entry 256 (class 1255 OID 159320)
...
--
-- TOC entry 257 (class 1255 OID 159321)
...
--
-- TOC entry 172 (class 1259 OID 159323)
...
--
-- TOC entry 173 (class 1259 OID 159329)
...
--
-- TOC entry 174 (class 1259 OID 159332)
...
--
-- TOC entry 175 (class 1259 OID 159335)
...
--
-- TOC entry 176 (class 1259 OID 159341)
...
--
-- TOC entry 177 (class 1259 OID 159347)
...
--
-- TOC entry 178 (class 1259 OID 159350)
...
--
-- TOC entry 179 (class 1259 OID 159353)
...
--
-- TOC entry 180 (class 1259 OID 159359)
...
--
-- TOC entry 181 (class 1259 OID 159362)
...
--
-- TOC entry 182 (class 1259 OID 159365)
...
--
-- TOC entry 183 (class 1259 OID 159368)
...
--
-- TOC entry 184 (class 1259 OID 159371)
...
--
-- TOC entry 185 (class 1259 OID 159374)
...
--
-- TOC entry 186 (class 1259 OID 159380)
...
--
-- TOC entry 187 (class 1259 OID 159384)
...
--
-- TOC entry 188 (class 1259 OID 159387)
...
--
-- TOC entry 189 (class 1259 OID 159392)
...
--
-- TOC entry 190 (class 1259 OID 159395)
...
--
-- TOC entry 191 (class 1259 OID 159400)
...
--
-- TOC entry 192 (class 1259 OID 159406)
...
--
-- TOC entry 193 (class 1259 OID 159409)
...
--
-- TOC entry 194 (class 1259 OID 159412)
...
--
-- TOC entry 195 (class 1259 OID 159415)
...
--
-- TOC entry 196 (class 1259 OID 159418)
...
--
-- TOC entry 197 (class 1259 OID 159421)
...
--
-- TOC entry 198 (class 1259 OID 159424)
...
--
-- TOC entry 199 (class 1259 OID 159427)
...
--
-- TOC entry 2244 (class 0 OID 159323)
-- Dependencies: 172
...
--
-- TOC entry 2245 (class 0 OID 159329)
-- Dependencies: 173
...
--
-- TOC entry 2246 (class 0 OID 159332)
-- Dependencies: 174
...
--
-- TOC entry 2247 (class 0 OID 159335)
-- Dependencies: 175
...
--
-- TOC entry 2248 (class 0 OID 159341)
-- Dependencies: 176
...
--
-- TOC entry 2249 (class 0 OID 159347)
-- Dependencies: 177
...
--
-- TOC entry 2250 (class 0 OID 159350)
-- Dependencies: 178
...
--
-- TOC entry 2251 (class 0 OID 159353)
-- Dependencies: 179
...
--
-- TOC entry 2252 (class 0 OID 159359)
-- Dependencies: 180
...
--
-- TOC entry 2253 (class 0 OID 159362)
-- Dependencies: 181
...
--
-- TOC entry 2254 (class 0 OID 159365)
-- Dependencies: 182
...
--
-- TOC entry 2255 (class 0 OID 159368)
-- Dependencies: 183
...
--
-- TOC entry 2256 (class 0 OID 159371)
-- Dependencies: 184
...
--
-- TOC entry 2257 (class 0 OID 159374)
-- Dependencies: 185
...
--
-- TOC entry 2258 (class 0 OID 159380)
-- Dependencies: 186
...
--
-- TOC entry 2259 (class 0 OID 159384)
-- Dependencies: 187
...
--
-- TOC entry 2261 (class 0 OID 159400)
-- Dependencies: 191
...
--
-- TOC entry 2262 (class 0 OID 159406)
-- Dependencies: 192
...
--
-- TOC entry 2263 (class 0 OID 159409)
-- Dependencies: 193
...
--
-- TOC entry 2264 (class 0 OID 159412)
-- Dependencies: 194
...
--
-- TOC entry 2265 (class 0 OID 159415)
-- Dependencies: 195
...
--
-- TOC entry 2266 (class 0 OID 159418)
-- Dependencies: 196
...
--
-- TOC entry 2267 (class 0 OID 159421)
-- Dependencies: 197
...
--
-- TOC entry 2260 (class 0 OID 159392)
-- Dependencies: 189
...
--
-- TOC entry 2268 (class 0 OID 159424)
-- Dependencies: 198
...
--
-- TOC entry 2269 (class 0 OID 159427)
-- Dependencies: 199
...
--
-- TOC entry 2052 (class 2606 OID 159431)
...
--
-- TOC entry 2056 (class 2606 OID 159433)
...
--
-- TOC entry 2058 (class 2606 OID 159435)
...
--
-- TOC entry 2060 (class 2606 OID 159437)
...
--
-- TOC entry 2062 (class 2606 OID 159439)
...
--
-- TOC entry 2064 (class 2606 OID 159441)
...
--
-- TOC entry 2068 (class 2606 OID 159443)
...
--
-- TOC entry 2066 (class 2606 OID 159445)
...
--
-- TOC entry 2070 (class 2606 OID 159447)
...
--
-- TOC entry 2072 (class 2606 OID 159449)
...
--
-- TOC entry 2074 (class 2606 OID 159451)
...
--
-- TOC entry 2076 (class 2606 OID 159453)
...
--
-- TOC entry 2078 (class 2606 OID 159455)
...
--
-- TOC entry 2080 (class 2606 OID 159457)
...
--
-- TOC entry 2082 (class 2606 OID 159459)
...
--
-- TOC entry 2086 (class 2606 OID 159461)
...
--
-- TOC entry 2054 (class 2606 OID 159463)
...
--
-- TOC entry 2088 (class 2606 OID 159465)
...
--
-- TOC entry 2090 (class 2606 OID 159467)
...
--
-- TOC entry 2092 (class 2606 OID 159469)
...
--
-- TOC entry 2094 (class 2606 OID 159471)
...
--
-- TOC entry 2096 (class 2606 OID 159473)
...
--
-- TOC entry 2098 (class 2606 OID 159475)
...
--
-- TOC entry 2084 (class 2606 OID 159477)
...
--
-- TOC entry 2100 (class 2606 OID 159479)
...
--
-- TOC entry 2102 (class 2606 OID 159481)
...
--
-- TOC entry 2131 (class 2620 OID 159482)
-- Name: tr_flightschedule; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER tr_flightschedule BEFORE INSERT OR UPDATE ON flightschedule FOR EACH ROW EXECUTE PROCEDURE tr_flightschedule();


--
-- TOC entry 2132 (class 2620 OID 159483)
-- Name: tr_staffschedule; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER tr_staffschedule BEFORE INSERT OR UPDATE ON staffschedule FOR EACH ROW EXECUTE PROCEDURE tr_staffschedule();


--
-- TOC entry 2103 (class 2606 OID 159484)
...
--
-- TOC entry 2104 (class 2606 OID 159489)
...
--
-- TOC entry 2105 (class 2606 OID 159494)
...
--
-- TOC entry 2106 (class 2606 OID 159499)
...
--
-- TOC entry 2109 (class 2606 OID 159504)
...
--
-- TOC entry 2107 (class 2606 OID 159509)
...
--
-- TOC entry 2108 (class 2606 OID 159514)
...
--
-- TOC entry 2110 (class 2606 OID 159519)
...
--
-- TOC entry 2111 (class 2606 OID 159524)
...
--
-- TOC entry 2112 (class 2606 OID 159529)
...
--
-- TOC entry 2113 (class 2606 OID 159534)
...
--
-- TOC entry 2114 (class 2606 OID 159539)
...
--
-- TOC entry 2115 (class 2606 OID 159544)
...
--
-- TOC entry 2116 (class 2606 OID 159549)
...
--
-- TOC entry 2117 (class 2606 OID 159554)
...
--
-- TOC entry 2118 (class 2606 OID 159559)
...
--
-- TOC entry 2121 (class 2606 OID 159564)
...
--
-- TOC entry 2122 (class 2606 OID 159569)
...
--
-- TOC entry 2123 (class 2606 OID 159574)
...
--
-- TOC entry 2124 (class 2606 OID 159579)
...
--
-- TOC entry 2125 (class 2606 OID 159584)
...
--
-- TOC entry 2126 (class 2606 OID 159589)
...
--
-- TOC entry 2127 (class 2606 OID 159594)
...
--
-- TOC entry 2128 (class 2606 OID 159599)
...
--
-- TOC entry 2129 (class 2606 OID 159604)
...
--
-- TOC entry 2119 (class 2606 OID 159609)
...
--
-- TOC entry 2120 (class 2606 OID 159614)
...
--
-- TOC entry 2130 (class 2606 OID 159619)
...
-- Completed on 2015-06-05 10:53:39
